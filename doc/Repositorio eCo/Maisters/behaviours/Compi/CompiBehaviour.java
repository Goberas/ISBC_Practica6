...
public class CompiBehaviour extends Behaviour {
	...
	public Boolean cond_0_0(){
		return ((myRobotAPI.getBall().r <= 0.05) && ((-myRobotAPI.getFieldSide() * myRobotAPI.getPosition().x < 1.10) || (myRobotAPI.canKick() == false)));
	}

//Conditions for State 0 : Node  1
	public Boolean cond_0_1(){
		return ((-myRobotAPI.getFieldSide() * myRobotAPI.getPosition().x >= 0.10) && (myRobotAPI.getBall().r == 0.05));
	}
...
//Conditions for State 1 : Node  9
	public Boolean cond_1_0(){
		return ((myRobotAPI.getBall().r > 0.05));
	}
