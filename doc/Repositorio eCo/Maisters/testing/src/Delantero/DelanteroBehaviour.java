...
//Conditions for State 0 : Node  1
	public Boolean cond_0_1(){
		return ((myRobotAPI.getBall().r <= 0.25) && (-myRobotAPI.getFieldSide() * myRobotAPI.toFieldCoordinates(myRobotAPI.getBall()).x >= 0));
	}
...
//Conditions for State 5 : Node 34
...
//Conditions for State 7 : Node 33
